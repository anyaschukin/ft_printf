...
/*   Updated: 2018/04/02 18:34:28 by aschukin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	flag_d(va_list *ap, t_print *arg)
{
	...
	nb = length_d(ap, arg);
	out.value = (nb == 0 && !arg->isplus && (arg->precision_field == 1 && arg->precision == 0) && arg->length == 1) ? ft_strdup("\0") : ft_strdup(ft_itoa(nb));
